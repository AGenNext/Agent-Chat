...
Agent Chat is the user-facing chat application. It talks to the authentication and identity layers, then sends chat turns to Agent Runtime. Runtime owns live behavior and state in the SurrealDB plane. Agent Graph remains the schema and contract source loaded into that plane.
